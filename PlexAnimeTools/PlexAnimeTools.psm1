...
if (Test-Path $publicPath) {
    ...
    # Export public functions - automatically exports all .ps1 files in Public folder
...
# =============================================================================
# EXPLICIT EXPORTS - Add SmartAnimeOrganize from Private
# =============================================================================

# The SmartAnimeOrganize function is in Private but needs to be public
# Export it explicitly along with its helper functions
Export-ModuleMember -Function @(
    'Invoke-SmartAnimeOrganize',
    'Get-SourceFileSeasonInfo',
    'Get-MALSeasonMapping', 
    'Merge-SourceAndMALData'
)
